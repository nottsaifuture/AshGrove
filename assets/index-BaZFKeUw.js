...
`)+`
`+d);const b=w+m+o,y=w+d+a,P=Ga(r,r.VERTEX_SHADER,b),C=Ga(r,r.FRAGMENT_SHADER,y);r.attachShader(g,P),r.attachShader(g,C),e.index0AttributeName!==void 0?r.bindAttribLocation(g,0,e.index0AttributeName):e.morphTargets===!0&&r.bindAttribLocation(g,0,"position"),r.linkProgram(g);function R(T){if(i.debug.checkShaderErrors){const I=r.getProgramInfoLog(g)||"",B=r.getShaderInfoLog(P)||"",H=r.getShaderInfoLog(C)||"",X=I.trim(),W=B.trim(),J=H.trim();let Y=!0,at=!0;if(r.getProgramParameter(g,r.LINK_STATUS)===!1)if(Y=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,g,P,C);else{const ut=Xa(r,P,"vertex"),bt=Xa(r,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(g,r.VALIDATE_STATUS)+`
