...
`].filter(Ki).join(`
`)),o=Mo(o),o=Ya(o,e),o=qa(o,e),a=Mo(a),a=Ya(a,e),a=qa(a,e),o=ja(o),a=ja(a),e.isRawShaderMaterial!==!0&&(b=`#version 300 es
...
`)+`
`+d);const T=b+m+o,y=b+d+a,P=Ga(r,r.VERTEX_SHADER,T),C=Ga(r,r.FRAGMENT_SHADER,y);r.attachShader(g,P),r.attachShader(g,C),e.index0AttributeName!==void 0?r.bindAttribLocation(g,0,e.index0AttributeName):e.morphTargets===!0&&r.bindAttribLocation(g,0,"position"),r.linkProgram(g);function R(I){if(i.debug.checkShaderErrors){const A=r.getProgramInfoLog(g)||"",O=r.getShaderInfoLog(P)||"",H=r.getShaderInfoLog(C)||"",V=A.trim(),Y=O.trim(),$=H.trim();let X=!0,at=!0;if(r.getProgramParameter(g,r.LINK_STATUS)===!1)if(X=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,g,P,C);else{const ut=Xa(r,P,"vertex"),bt=Xa(r,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(g,r.VALIDATE_STATUS)+`
...
}`;function fm(i,t,e){let n=new Uo;const r=new Et,s=new Et,o=new Qt,a=new Lh({depthPacking:Pc}),l=new Ih,c={},p=e.maxTextureSize,f={[Vn]:Ge,[Ge]:Vn,[bn]:bn},u=new Rn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Et},radius:{value:4}},vertexShader:um,fragmentShader:dm}),h=u.clone();h.defines.HORIZONTAL_PASS=1;const _=new Qe;_.setAttribute("position",new dn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const g=new Ae(_,u),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ol;let d=this.type;this.render=function(C,R,L){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||C.length===0)return;const v=i.getRenderTarget(),S=i.getActiveCubeFace(),I=i.getActiveMipmapLevel(),A=i.state;A.setBlending(kn),A.buffers.depth.getReversed()===!0?A.buffers.color.setClear(0,0,0,0):A.buffers.color.setClear(1,1,1,1),A.buffers.depth.setTest(!0),A.setScissorTest(!1);const O=d!==yn&&this.type===yn,H=d===yn&&this.type!==yn;for(let V=0,Y=C.length;V<Y;V++){const $=C[V],X=$.shadow;if(X===void 0){console.warn("THREE.WebGLShadowMap:",$,"has no shadow.");continue}if(X.autoUpdate===!1&&X.needsUpdate===!1)continue;r.copy(X.mapSize);const at=X.getFrameExtents();if(r.multiply(at),s.copy(X.mapSize),(r.x>p||r.y>p)&&(r.x>p&&(s.x=Math.floor(p/at.x),r.x=s.x*at.x,X.mapSize.x=s.x),r.y>p&&(s.y=Math.floor(p/at.y),r.y=s.y*at.y,X.mapSize.y=s.y)),X.map===null||O===!0||H===!0){const bt=this.type!==yn?{minFilter:on,magFilter:on}:{};X.map!==null&&X.map.dispose(),X.map=new Gn(r.x,r.y,bt),X.map.texture.name=$.name+".shadowMap",X.camera.updateProjectionMatrix()}i.setRenderTarget(X.map),i.clear();const ut=X.getViewportCount();for(let bt=0;bt<ut;bt++){const Wt=X.getViewport(bt);o.set(s.x*Wt.x,s.y*Wt.y,s.x*Wt.z,s.y*Wt.w),A.viewport(o),X.updateMatrices($,bt),n=X.getFrustum(),y(R,L,X.camera,$,this.type)}X.isPointLightShadow!==!0&&this.type===yn&&b(X,L),X.needsUpdate=!1}d=this.type,m.needsUpdate=!1,i.setRenderTarget(v,S,I)};function b(C,R){const L=t.update(g);u.defines.VSM_SAMPLES!==C.blurSamples&&(u.defines.VSM_SAMPLES=C.blurSamples,h.defines.VSM_SAMPLES=C.blurSamples,u.needsUpdate=!0,h.needsUpdate=!0),C.mapPass===null&&(C.mapPass=new Gn(r.x,r.y)),u.uniforms.shadow_pass.value=C.map.texture,u.uniforms.resolution.value=C.mapSize,u.uniforms.radius.value=C.radius,i.setRenderTarget(C.mapPass),i.clear(),i.renderBufferDirect(R,null,L,u,g,null),h.uniforms.shadow_pass.value=C.mapPass.texture,h.uniforms.resolution.value=C.mapSize,h.uniforms.radius.value=C.radius,i.setRenderTarget(C.map),i.clear(),i.renderBufferDirect(R,null,L,h,g,null)}function T(C,R,L,v){let S=null;const I=L.isPointLight===!0?C.customDistanceMaterial:C.customDepthMaterial;if(I!==void 0)S=I;else if(S=L.isPointLight===!0?l:a,i.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){const A=S.uuid,O=R.uuid;let H=c[A];H===void 0&&(H={},c[A]=H);let V=H[O];V===void 0&&(V=S.clone(),H[O]=V,R.addEventListener("dispose",P)),S=V}if(S.visible=R.visible,S.wireframe=R.wireframe,v===yn?S.side=R.shadowSide!==null?R.shadowSide:R.side:S.side=R.shadowSide!==null?R.shadowSide:f[R.side],S.alphaMap=R.alphaMap,S.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,S.map=R.map,S.clipShadows=R.clipShadows,S.clippingPlanes=R.clippingPlanes,S.clipIntersection=R.clipIntersection,S.displacementMap=R.displacementMap,S.displacementScale=R.displacementScale,S.displacementBias=R.displacementBias,S.wireframeLinewidth=R.wireframeLinewidth,S.linewidth=R.linewidth,L.isPointLight===!0&&S.isMeshDistanceMaterial===!0){const A=i.properties.get(S);A.light=L}return S}function y(C,R,L,v,S){if(C.visible===!1)return;if(C.layers.test(R.layers)&&(C.isMesh||C.isLine||C.isPoints)&&(C.castShadow||C.receiveShadow&&S===yn)&&(!C.frustumCulled||n.intersectsObject(C))){C.modelViewMatrix.multiplyMatrices(L.matrixWorldInverse,C.matrixWorld);const O=t.update(C),H=C.material;if(Array.isArray(H)){const V=O.groups;for(let Y=0,$=V.length;Y<$;Y++){const X=V[Y],at=H[X.materialIndex];if(at&&at.visible){const ut=T(C,at,v,S);C.onBeforeShadow(i,C,R,L,O,ut,X),i.renderBufferDirect(L,null,O,ut,C,X),C.onAfterShadow(i,C,R,L,O,ut,X)}}}else if(H.visible){const V=T(C,H,v,S);C.onBeforeShadow(i,C,R,L,O,V,null),i.renderBufferDirect(L,null,O,V,C,null),C.onAfterShadow(i,C,R,L,O,V,null)}}const A=C.children;for(let O=0,H=A.length;O<H;O++)y(A[O],R,L,v,S)}function P(C){C.target.removeEventListener("dispose",P);for(const L in c){const v=c[L],S=C.target.uuid;S in v&&(v[S].dispose(),delete v[S])}}}const pm={[Us]:Ns,[Fs]:zs,[Os]:ks,[Li]:Bs,[Ns]:Us,[zs]:Fs,[ks]:Os,[Bs]:Li};function mm(i,t){function e(){let N=!1;const it=new Qt;let st=null;const ft=new Qt(0,0,0,0);return{setMask:function(tt){st!==tt&&!N&&(i.colorMask(tt,tt,tt,tt),st=tt)},setLocked:function(tt){N=tt},setClear:function(tt,Z,_t,Ft,se){se===!0&&(tt*=Ft,Z*=Ft,_t*=Ft),it.set(tt,Z,_t,Ft),ft.equals(it)===!1&&(i.clearColor(tt,Z,_t,Ft),ft.copy(it))},reset:function(){N=!1,st=null,ft.set(-1,0,0,0)}}}function n(){let N=!1,it=!1,st=null,ft=null,tt=null;return{setReversed:function(Z){if(it!==Z){const _t=t.get("EXT_clip_control");Z?_t.clipControlEXT(_t.LOWER_LEFT_EXT,_t.ZERO_TO_ONE_EXT):_t.clipControlEXT(_t.LOWER_LEFT_EXT,_t.NEGATIVE_ONE_TO_ONE_EXT),it=Z;const Ft=tt;tt=null,this.setClear(Ft)}},getReversed:function(){return it},setTest:function(Z){Z?Q(i.DEPTH_TEST):pt(i.DEPTH_TEST)},setMask:function(Z){st!==Z&&!N&&(i.depthMask(Z),st=Z)},setFunc:function(Z){if(it&&(Z=pm[Z]),ft!==Z){switch(Z){case Us:i.depthFunc(i.NEVER);break;case Ns:i.depthFunc(i.ALWAYS);break;case Fs:i.depthFunc(i.LESS);break;case Li:i.depthFunc(i.LEQUAL);break;case Os:i.depthFunc(i.EQUAL);break;case Bs:i.depthFunc(i.GEQUAL);break;case zs:i.depthFunc(i.GREATER);break;case ks:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}ft=Z}},setLocked:function(Z){N=Z},setClear:function(Z){tt!==Z&&(it&&(Z=1-Z),i.clearDepth(Z),tt=Z)},reset:function(){N=!1,st=null,ft=null,tt=null,it=!1}}}function r(){let N=!1,it=null,st=null,ft=null,tt=null,Z=null,_t=null,Ft=null,se=null;return{setTest:function(Jt){N||(Jt?Q(i.STENCIL_TEST):pt(i.STENCIL_TEST))},setMask:function(Jt){it!==Jt&&!N&&(i.stencilMask(Jt),it=Jt)},setFunc:function(Jt,gn,an){(st!==Jt||ft!==gn||tt!==an)&&(i.stencilFunc(Jt,gn,an),st=Jt,ft=gn,tt=an)},setOp:function(Jt,gn,an){(Z!==Jt||_t!==gn||Ft!==an)&&(i.stencilOp(Jt,gn,an),Z=Jt,_t=gn,Ft=an)},setLocked:function(Jt){N=Jt},setClear:function(Jt){se!==Jt&&(i.clearStencil(Jt),se=Jt)},reset:function(){N=!1,it=null,st=null,ft=null,tt=null,Z=null,_t=null,Ft=null,se=null}}}const s=new e,o=new n,a=new r,l=new WeakMap,c=new WeakMap;let p={},f={},u=new WeakMap,h=[],_=null,g=!1,m=null,d=null,b=null,T=null,y=null,P=null,C=null,R=new Yt(0,0,0),L=0,v=!1,S=null,I=null,A=null,O=null,H=null;const V=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let Y=!1,$=0;const X=i.getParameter(i.VERSION);X.indexOf("WebGL")!==-1?($=parseFloat(/^WebGL (\d)/.exec(X)[1]),Y=$>=1):X.indexOf("OpenGL ES")!==-1&&($=parseFloat(/^OpenGL ES (\d)/.exec(X)[1]),Y=$>=2);let at=null,ut={};const bt=i.getParameter(i.SCISSOR_BOX),Wt=i.getParameter(i.VIEWPORT),re=new Qt().fromArray(bt),he=new Qt().fromArray(Wt);function $t(N,it,st,ft){const tt=new Uint8Array(4),Z=i.createTexture();i.bindTexture(N,Z),i.texParameteri(N,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(N,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let _t=0;_t<st;_t++)N===i.TEXTURE_3D||N===i.TEXTURE_2D_ARRAY?i.texImage3D(it,0,i.RGBA,1,1,ft,0,i.RGBA,i.UNSIGNED_BYTE,tt):i.texImage2D(it+_t,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,tt);return Z}const K={};K[i.TEXTURE_2D]=$t(i.TEXTURE_2D,i.TEXTURE_2D,1),K[i.TEXTURE_CUBE_MAP]=$t(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),K[i.TEXTURE_2D_ARRAY]=$t(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),K[i.TEXTURE_3D]=$t(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),Q(i.DEPTH_TEST),o.setFunc(Li),It(!1),gt($o),Q(i.CULL_FACE),ue(kn);function Q(N){p[N]!==!0&&(i.enable(N),p[N]=!0)}function pt(N){p[N]!==!1&&(i.disable(N),p[N]=!1)}function Nt(N,it){return f[N]!==it?(i.bindFramebuffer(N,it),f[N]=it,N===i.DRAW_FRAMEBUFFER&&(f[i.FRAMEBUFFER]=it),N===i.FRAMEBUFFER&&(f[i.DRAW_FRAMEBUFFER]=it),!0):!1}function Tt(N,it){let st=h,ft=!1;if(N){st=u.get(it),st===void 0&&(st=[],u.set(it,st));const tt=N.textures;if(st.length!==tt.length||st[0]!==i.COLOR_ATTACHMENT0){for(let Z=0,_t=tt.length;Z<_t;Z++)st[Z]=i.COLOR_ATTACHMENT0+Z;st.length=tt.length,ft=!0}}else st[0]!==i.BACK&&(st[0]=i.BACK,ft=!0);ft&&i.drawBuffers(st)}function qt(N){return _!==N?(i.useProgram(N),_=N,!0):!1}const Ce={[ni]:i.FUNC_ADD,[ic]:i.FUNC_SUBTRACT,[rc]:i.FUNC_REVERSE_SUBTRACT};Ce[sc]=i.MIN,Ce[oc]=i.MAX;const D={[ac]:i.ZERO,[lc]:i.ONE,[cc]:i.SRC_COLOR,[Ls]:i.SRC_ALPHA,[mc]:i.SRC_ALPHA_SATURATE,[fc]:i.DST_COLOR,[uc]:i.DST_ALPHA,[hc]:i.ONE_MINUS_SRC_COLOR,[Is]:i.ONE_MINUS_SRC_ALPHA,[pc]:i.ONE_MINUS_DST_COLOR,[dc]:i.ONE_MINUS_DST_ALPHA,[_c]:i.CONSTANT_COLOR,[gc]:i.ONE_MINUS_CONSTANT_COLOR,[vc]:i.CONSTANT_ALPHA,[xc]:i.ONE_MINUS_CONSTANT_ALPHA};function ue(N,it,st,ft,tt,Z,_t,Ft,se,Jt){if(N===kn){g===!0&&(pt(i.BLEND),g=!1);return}if(g===!1&&(Q(i.BLEND),g=!0),N!==nc){if(N!==m||Jt!==v){if((d!==ni||y!==ni)&&(i.blendEquation(i.FUNC_ADD),d=ni,y=ni),Jt)switch(N){case Pi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Jo:i.blendFunc(i.ONE,i.ONE);break;case Qo:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case ta:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",N);break}else switch(N){case Pi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Jo:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case Qo:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case ta:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",N);break}b=null,T=null,P=null,C=null,R.set(0,0,0),L=0,m=N,v=Jt}return}tt=tt||it,Z=Z||st,_t=_t||ft,(it!==d||tt!==y)&&(i.blendEquationSeparate(Ce[it],Ce[tt]),d=it,y=tt),(st!==b||ft!==T||Z!==P||_t!==C)&&(i.blendFuncSeparate(D[st],D[ft],D[Z],D[_t]),b=st,T=ft,P=Z,C=_t),(Ft.equals(R)===!1||se!==L)&&(i.blendColor(Ft.r,Ft.g,Ft.b,se),R.copy(Ft),L=se),m=N,v=!1}function Ot(N,it){N.side===bn?pt(i.CULL_FACE):Q(i.CULL_FACE);let st=N.side===Ge;it&&(st=!st),It(st),N.blending===Pi&&N.transparent===!1?ue(kn):ue(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),o.setFunc(N.depthFunc),o.setTest(N.depthTest),o.setMask(N.depthWrite),s.setMask(N.colorWrite);const ft=N.stencilWrite;a.setTest(ft),ft&&(a.setMask(N.stencilWriteMask),a.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),a.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),vt(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?Q(i.SAMPLE_ALPHA_TO_COVERAGE):pt(i.SAMPLE_ALPHA_TO_COVERAGE)}function It(N){S!==N&&(N?i.frontFace(i.CW):i.frontFace(i.CCW),S=N)}function gt(N){N!==tc?(Q(i.CULL_FACE),N!==I&&(N===$o?i.cullFace(i.BACK):N===ec?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):pt(i.CULL_FACE),I=N}function de(N){N!==A&&(Y&&i.lineWidth(N),A=N)}function vt(N,it,st){N?(Q(i.POLYGON_OFFSET_FILL),(O!==it||H!==st)&&(i.polygonOffset(it,st),O=it,H=st)):pt(i.POLYGON_OFFSET_FILL)}function kt(N){N?Q(i.SCISSOR_TEST):pt(i.SCISSOR_TEST)}function ye(N){N===void 0&&(N=i.TEXTURE0+V-1),at!==N&&(i.activeTexture(N),at=N)}function ge(N,it,st){st===void 0&&(at===null?st=i.TEXTURE0+V-1:st=at);let ft=ut[st];ft===void 0&&(ft={type:void 0,texture:void 0},ut[st]=ft),(ft.type!==N||ft.texture!==it)&&(at!==st&&(i.activeTexture(st),at=st),i.bindTexture(N,it||K[N]),ft.type=N,ft.texture=it)}function w(){const N=ut[at];N!==void 0&&N.type!==void 0&&(i.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function x(){try{i.compressedTexImage2D(...arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function k(){try{i.compressedTexImage3D(...arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function j(){try{i.texSubImage2D(...arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function J(){try{i.texSubImage3D(...arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function q(){try{i.compressedTexSubImage2D(...arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function yt(){try{i.compressedTexSubImage3D(...arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function rt(){try{i.texStorage2D(...arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function xt(){try{i.texStorage3D(...arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Mt(){try{i.texImage2D(...arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function nt(){try{i.texImage3D(...arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function ht(N){re.equals(N)===!1&&(i.scissor(N.x,N.y,N.z,N.w),re.copy(N))}function Lt(N){he.equals(N)===!1&&(i.viewport(N.x,N.y,N.z,N.w),he.copy(N))}function St(N,it){let st=c.get(it);st===void 0&&(st=new WeakMap,c.set(it,st));let ft=st.get(N);ft===void 0&&(ft=i.getUniformBlockIndex(it,N.name),st.set(N,ft))}function lt(N,it){const ft=c.get(it).get(N);l.get(it)!==ft&&(i.uniformBlockBinding(it,ft,N.__bindingPointIndex),l.set(it,ft))}function Bt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),o.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),p={},at=null,ut={},f={},u=new WeakMap,h=[],_=null,g=!1,m=null,d=null,b=null,T=null,y=null,P=null,C=null,R=new Yt(0,0,0),L=0,v=!1,S=null,I=null,A=null,O=null,H=null,re.set(0,0,i.canvas.width,i.canvas.height),he.set(0,0,i.canvas.width,i.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:Q,disable:pt,bindFramebuffer:Nt,drawBuffers:Tt,useProgram:qt,setBlending:ue,setMaterial:Ot,setFlipSided:It,setCullFace:gt,setLineWidth:de,setPolygonOffset:vt,setScissorTest:kt,activeTexture:ye,bindTexture:ge,unbindTexture:w,compressedTexImage2D:x,compressedTexImage3D:k,texImage2D:Mt,texImage3D:nt,updateUBOMapping:St,uniformBlockBinding:lt,texStorage2D:rt,texStorage3D:xt,texSubImage2D:j,texSubImage3D:J,compressedTexSubImage2D:q,compressedTexSubImage3D:yt,scissor:ht,viewport:Lt,reset:Bt}}function _m(i,t,e,n,r,s,o){const a=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Et,p=new WeakMap;let f;const u=new WeakMap;let h=!1;try{h=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(w,x){return h?new OffscreenCanvas(w,x):Xr("canvas")}function g(w,x,k){let j=1;const J=ge(w);if((J.width>k||J.height>k)&&(j=k/Math.max(J.width,J.height)),j<1)if(typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&w instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&w instanceof ImageBitmap||typeof VideoFrame<"u"&&w instanceof VideoFrame){const q=Math.floor(j*J.width),yt=Math.floor(j*J.height);f===void 0&&(f=_(q,yt));const rt=x?_(q,yt):f;return rt.width=q,rt.height=yt,rt.getContext("2d").drawImage(w,0,0,q,yt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+q+"x"+yt+")."),rt}else return"data"in w&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),w;return w}function m(w){return w.generateMipmaps}function d(w){i.generateMipmap(w)}function b(w){return w.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:w.isWebGL3DRenderTarget?i.TEXTURE_3D:w.isWebGLArrayRenderTarget||w.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function T(w,x,k,j,J=!1){if(w!==null){if(i[w]!==void 0)return i[w];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+w+"'")}let q=x;if(x===i.RED&&(k===i.FLOAT&&(q=i.R32F),k===i.HALF_FLOAT&&(q=i.R16F),k===i.UNSIGNED_BYTE&&(q=i.R8)),x===i.RED_INTEGER&&(k===i.UNSIGNED_BYTE&&(q=i.R8UI),k===i.UNSIGNED_SHORT&&(q=i.R16UI),k===i.UNSIGNED_INT&&(q=i.R32UI),k===i.BYTE&&(q=i.R8I),k===i.SHORT&&(q=i.R16I),k===i.INT&&(q=i.R32I)),x===i.RG&&(k===i.FLOAT&&(q=i.RG32F),k===i.HALF_FLOAT&&(q=i.RG16F),k===i.UNSIGNED_BYTE&&(q=i.RG8)),x===i.RG_INTEGER&&(k===i.UNSIGNED_BYTE&&(q=i.RG8UI),k===i.UNSIGNED_SHORT&&(q=i.RG16UI),k===i.UNSIGNED_INT&&(q=i.RG32UI),k===i.BYTE&&(q=i.RG8I),k===i.SHORT&&(q=i.RG16I),k===i.INT&&(q=i.RG32I)),x===i.RGB_INTEGER&&(k===i.UNSIGNED_BYTE&&(q=i.RGB8UI),k===i.UNSIGNED_SHORT&&(q=i.RGB16UI),k===i.UNSIGNED_INT&&(q=i.RGB32UI),k===i.BYTE&&(q=i.RGB8I),k===i.SHORT&&(q=i.RGB16I),k===i.INT&&(q=i.RGB32I)),x===i.RGBA_INTEGER&&(k===i.UNSIGNED_BYTE&&(q=i.RGBA8UI),k===i.UNSIGNED_SHORT&&(q=i.RGBA16UI),k===i.UNSIGNED_INT&&(q=i.RGBA32UI),k===i.BYTE&&(q=i.RGBA8I),k===i.SHORT&&(q=i.RGBA16I),k===i.INT&&(q=i.RGBA32I)),x===i.RGB&&(k===i.UNSIGNED_INT_5_9_9_9_REV&&(q=i.RGB9_E5),k===i.UNSIGNED_INT_10F_11F_11F_REV&&(q=i.R11F_G11F_B10F)),x===i.RGBA){const yt=J?Gr:Kt.getTransfer(j);k===i.FLOAT&&(q=i.RGBA32F),k===i.HALF_FLOAT&&(q=i.RGBA16F),k===i.UNSIGNED_BYTE&&(q=yt===ee?i.SRGB8_ALPHA8:i.RGBA8),k===i.UNSIGNED_SHORT_4_4_4_4&&(q=i.RGBA4),k===i.UNSIGNED_SHORT_5_5_5_1&&(q=i.RGB5_A1)}return(q===i.R16F||q===i.R32F||q===i.RG16F||q===i.RG32F||q===i.RGBA16F||q===i.RGBA32F)&&t.get("EXT_color_buffer_float"),q}function y(w,x){let k;return w?x===null||x===oi||x===tr?k=i.DEPTH24_STENCIL8:x===wn?k=i.DEPTH32F_STENCIL8:x===Qi&&(k=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):x===null||x===oi||x===tr?k=i.DEPTH_COMPONENT24:x===wn?k=i.DEPTH_COMPONENT32F:x===Qi&&(k=i.DEPTH_COMPONENT16),k}function P(w,x){return m(w)===!0||w.isFramebufferTexture&&w.minFilter!==on&&w.minFilter!==hn?Math.log2(Math.max(x.width,x.height))+1:w.mipmaps!==void 0&&w.mipmaps.length>0?w.mipmaps.length:w.isCompressedTexture&&Array.isArray(w.image)?x.mipmaps.length:1}function C(w){const x=w.target;x.removeEventListener("dispose",C),L(x),x.isVideoTexture&&p.delete(x)}function R(w){const x=w.target;x.removeEventListener("dispose",R),S(x)}function L(w){const x=n.get(w);if(x.__webglInit===void 0)return;const k=w.source,j=u.get(k);if(j){const J=j[x.__cacheKey];J.usedTimes--,J.usedTimes===0&&v(w),Object.keys(j).length===0&&u.delete(k)}n.remove(w)}function v(w){const x=n.get(w);i.deleteTexture(x.__webglTexture);const k=w.source,j=u.get(k);delete j[x.__cacheKey],o.memory.textures--}function S(w){const x=n.get(w);if(w.depthTexture&&(w.depthTexture.dispose(),n.remove(w.depthTexture)),w.isWebGLCubeRenderTarget)for(let j=0;j<6;j++){if(Array.isArray(x.__webglFramebuffer[j]))for(let J=0;J<x.__webglFramebuffer[j].length;J++)i.deleteFramebuffer(x.__webglFramebuffer[j][J]);else i.deleteFramebuffer(x.__webglFramebuffer[j]);x.__webglDepthbuffer&&i.deleteRenderbuffer(x.__webglDepthbuffer[j])}else{if(Array.isArray(x.__webglFramebuffer))for(let j=0;j<x.__webglFramebuffer.length;j++)i.deleteFramebuffer(x.__webglFramebuffer[j]);else i.deleteFramebuffer(x.__webglFramebuffer);if(x.__webglDepthbuffer&&i.deleteRenderbuffer(x.__webglDepthbuffer),x.__webglMultisampledFramebuffer&&i.deleteFramebuffer(x.__webglMultisampledFramebuffer),x.__webglColorRenderbuffer)for(let j=0;j<x.__webglColorRenderbuffer.length;j++)x.__webglColorRenderbuffer[j]&&i.deleteRenderbuffer(x.__webglColorRenderbuffer[j]);x.__webglDepthRenderbuffer&&i.deleteRenderbuffer(x.__webglDepthRenderbuffer)}const k=w.textures;for(let j=0,J=k.length;j<J;j++){const q=n.get(k[j]);q.__webglTexture&&(i.deleteTexture(q.__webglTexture),o.memory.textures--),n.remove(k[j])}n.remove(w)}let I=0;function A(){I=0}function O(){const w=I;return w>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+w+" texture units while this GPU supports only "+r.maxTextures),I+=1,w}function H(w){const x=[];return x.push(w.wrapS),x.push(w.wrapT),x.push(w.wrapR||0),x.push(w.magFilter),x.push(w.minFilter),x.push(w.anisotropy),x.push(w.internalFormat),x.push(w.format),x.push(w.type),x.push(w.generateMipmaps),x.push(w.premultiplyAlpha),x.push(w.flipY),x.push(w.unpackAlignment),x.push(w.colorSpace),x.join()}function V(w,x){const k=n.get(w);if(w.isVideoTexture&&kt(w),w.isRenderTargetTexture===!1&&w.isExternalTexture!==!0&&w.version>0&&k.__version!==w.version){const j=w.image;if(j===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(j.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{K(k,w,x);return}}else w.isExternalTexture&&(k.__webglTexture=w.sourceTexture?w.sourceTexture:null);e.bindTexture(i.TEXTURE_2D,k.__webglTexture,i.TEXTURE0+x)}function Y(w,x){const k=n.get(w);if(w.isRenderTargetTexture===!1&&w.version>0&&k.__version!==w.version){K(k,w,x);return}e.bindTexture(i.TEXTURE_2D_ARRAY,k.__webglTexture,i.TEXTURE0+x)}function $(w,x){const k=n.get(w);if(w.isRenderTargetTexture===!1&&w.version>0&&k.__version!==w.version){K(k,w,x);return}e.bindTexture(i.TEXTURE_3D,k.__webglTexture,i.TEXTURE0+x)}function X(w,x){const k=n.get(w);if(w.version>0&&k.__version!==w.version){Q(k,w,x);return}e.bindTexture(i.TEXTURE_CUBE_MAP,k.__webglTexture,i.TEXTURE0+x)}const at={[Vr]:i.REPEAT,[ri]:i.CLAMP_TO_EDGE,[Gs]:i.MIRRORED_REPEAT},ut={[on]:i.NEAREST,[Rc]:i.NEAREST_MIPMAP_NEAREST,[dr]:i.NEAREST_MIPMAP_LINEAR,[hn]:i.LINEAR,[Qr]:i.LINEAR_MIPMAP_NEAREST,[si]:i.LINEAR_MIPMAP_LINEAR},bt={[Lc]:i.NEVER,[Bc]:i.ALWAYS,[Ic]:i.LESS,[Ml]:i.LEQUAL,[Uc]:i.EQUAL,[Oc]:i.GEQUAL,[Nc]:i.GREATER,[Fc]:i.NOTEQUAL};function Wt(w,x){if(x.type===wn&&t.has("OES_texture_float_linear")===!1&&(x.magFilter===hn||x.magFilter===Qr||x.magFilter===dr||x.magFilter===si||x.minFilter===hn||x.minFilter===Qr||x.minFilter===dr||x.minFilter===si)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(w,i.TEXTURE_WRAP_S,at[x.wrapS]),i.texParameteri(w,i.TEXTURE_WRAP_T,at[x.wrapT]),(w===i.TEXTURE_3D||w===i.TEXTURE_2D_ARRAY)&&i.texParameteri(w,i.TEXTURE_WRAP_R,at[x.wrapR]),i.texParameteri(w,i.TEXTURE_MAG_FILTER,ut[x.magFilter]),i.texParameteri(w,i.TEXTURE_MIN_FILTER,ut[x.minFilter]),x.compareFunction&&(i.texParameteri(w,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(w,i.TEXTURE_COMPARE_FUNC,bt[x.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(x.magFilter===on||x.minFilter!==dr&&x.minFilter!==si||x.type===wn&&t.has("OES_texture_float_linear")===!1)return;if(x.anisotropy>1||n.get(x).__currentAnisotropy){const k=t.get("EXT_texture_filter_anisotropic");i.texParameterf(w,k.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,r.getMaxAnisotropy())),n.get(x).__currentAnisotropy=x.anisotropy}}}function re(w,x){let k=!1;w.__webglInit===void 0&&(w.__webglInit=!0,x.addEventListener("dispose",C));const j=x.source;let J=u.get(j);J===void 0&&(J={},u.set(j,J));const q=H(x);if(q!==w.__cacheKey){J[q]===void 0&&(J[q]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,k=!0),J[q].usedTimes++;const yt=J[w.__cacheKey];yt!==void 0&&(J[w.__cacheKey].usedTimes--,yt.usedTimes===0&&v(x)),w.__cacheKey=q,w.__webglTexture=J[q].texture}return k}function he(w,x,k){return Math.floor(Math.floor(w/k)/x)}function $t(w,x,k,j){const q=w.updateRanges;if(q.length===0)e.texSubImage2D(i.TEXTURE_2D,0,0,0,x.width,x.height,k,j,x.data);else{q.sort((nt,ht)=>nt.start-ht.start);let yt=0;for(let nt=1;nt<q.length;nt++){const ht=q[yt],Lt=q[nt],St=ht.start+ht.count,lt=he(Lt.start,x.width,4),Bt=he(ht.start,x.width,4);Lt.start<=St+1&&lt===Bt&&he(Lt.start+Lt.count-1,x.width,4)===lt?ht.count=Math.max(ht.count,Lt.start+Lt.count-ht.start):(++yt,q[yt]=Lt)}q.length=yt+1;const rt=i.getParameter(i.UNPACK_ROW_LENGTH),xt=i.getParameter(i.UNPACK_SKIP_PIXELS),Mt=i.getParameter(i.UNPACK_SKIP_ROWS);i.pixelStorei(i.UNPACK_ROW_LENGTH,x.width);for(let nt=0,ht=q.length;nt<ht;nt++){const Lt=q[nt],St=Math.floor(Lt.start/4),lt=Math.ceil(Lt.count/4),Bt=St%x.width,N=Math.floor(St/x.width),it=lt,st=1;i.pixelStorei(i.UNPACK_SKIP_PIXELS,Bt),i.pixelStorei(i.UNPACK_SKIP_ROWS,N),e.texSubImage2D(i.TEXTURE_2D,0,Bt,N,it,st,k,j,x.data)}w.clearUpdateRanges(),i.pixelStorei(i.UNPACK_ROW_LENGTH,rt),i.pixelStorei(i.UNPACK_SKIP_PIXELS,xt),i.pixelStorei(i.UNPACK_SKIP_ROWS,Mt)}}function K(w,x,k){let j=i.TEXTURE_2D;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&(j=i.TEXTURE_2D_ARRAY),x.isData3DTexture&&(j=i.TEXTURE_3D);const J=re(w,x),q=x.source;e.bindTexture(j,w.__webglTexture,i.TEXTURE0+k);const yt=n.get(q);if(q.version!==yt.__version||J===!0){e.activeTexture(i.TEXTURE0+k);const rt=Kt.getPrimaries(Kt.workingColorSpace),xt=x.colorSpace===Bn?null:Kt.getPrimaries(x.colorSpace),Mt=x.colorSpace===Bn||rt===xt?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,x.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,x.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Mt);let nt=g(x.image,!1,r.maxTextureSize);nt=ye(x,nt);const ht=s.convert(x.format,x.colorSpace),Lt=s.convert(x.type);let St=T(x.internalFormat,ht,Lt,x.colorSpace,x.isVideoTexture);Wt(j,x);let lt;const Bt=x.mipmaps,N=x.isVideoTexture!==!0,it=yt.__version===void 0||J===!0,st=q.dataReady,ft=P(x,nt);if(x.isDepthTexture)St=y(x.format===nr,x.type),it&&(N?e.texStorage2D(i.TEXTURE_2D,1,St,nt.width,nt.height):e.texImage2D(i.TEXTURE_2D,0,St,nt.width,nt.height,0,ht,Lt,null));else if(x.isDataTexture)if(Bt.length>0){N&&it&&e.texStorage2D(i.TEXTURE_2D,ft,St,Bt[0].width,Bt[0].height);for(let tt=0,Z=Bt.length;tt<Z;tt++)lt=Bt[tt],N?st&&e.texSubImage2D(i.TEXTURE_2D,tt,0,0,lt.width,lt.height,ht,Lt,lt.data):e.texImage2D(i.TEXTURE_2D,tt,St,lt.width,lt.height,0,ht,Lt,lt.data);x.generateMipmaps=!1}else N?(it&&e.texStorage2D(i.TEXTURE_2D,ft,St,nt.width,nt.height),st&&$t(x,nt,ht,Lt)):e.texImage2D(i.TEXTURE_2D,0,St,nt.width,nt.height,0,ht,Lt,nt.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){N&&it&&e.texStorage3D(i.TEXTURE_2D_ARRAY,ft,St,Bt[0].width,Bt[0].height,nt.depth);for(let tt=0,Z=Bt.length;tt<Z;tt++)if(lt=Bt[tt],x.format!==sn)if(ht!==null)if(N){if(st)if(x.layerUpdates.size>0){const _t=Ra(lt.width,lt.height,x.format,x.type);for(const Ft of x.layerUpdates){const se=lt.data.subarray(Ft*_t/lt.data.BYTES_PER_ELEMENT,(Ft+1)*_t/lt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,tt,0,0,Ft,lt.width,lt.height,1,ht,se)}x.clearLayerUpdates()}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,tt,0,0,0,lt.width,lt.height,nt.depth,ht,lt.data)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,tt,St,lt.width,lt.height,nt.depth,0,lt.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else N?st&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,tt,0,0,0,lt.width,lt.height,nt.depth,ht,Lt,lt.data):e.texImage3D(i.TEXTURE_2D_ARRAY,tt,St,lt.width,lt.height,nt.depth,0,ht,Lt,lt.data)}else{N&&it&&e.texStorage2D(i.TEXTURE_2D,ft,St,Bt[0].width,Bt[0].height);for(let tt=0,Z=Bt.length;tt<Z;tt++)lt=Bt[tt],x.format!==sn?ht!==null?N?st&&e.compressedTexSubImage2D(i.TEXTURE_2D,tt,0,0,lt.width,lt.height,ht,lt.data):e.compressedTexImage2D(i.TEXTURE_2D,tt,St,lt.width,lt.height,0,lt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):N?st&&e.texSubImage2D(i.TEXTURE_2D,tt,0,0,lt.width,lt.height,ht,Lt,lt.data):e.texImage2D(i.TEXTURE_2D,tt,St,lt.width,lt.height,0,ht,Lt,lt.data)}else if(x.isDataArrayTexture)if(N){if(it&&e.texStorage3D(i.TEXTURE_2D_ARRAY,ft,St,nt.width,nt.height,nt.depth),st)if(x.layerUpdates.size>0){const tt=Ra(nt.width,nt.height,x.format,x.type);for(const Z of x.layerUpdates){const _t=nt.data.subarray(Z*tt/nt.data.BYTES_PER_ELEMENT,(Z+1)*tt/nt.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,Z,nt.width,nt.height,1,ht,Lt,_t)}x.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,nt.width,nt.height,nt.depth,ht,Lt,nt.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,St,nt.width,nt.height,nt.depth,0,ht,Lt,nt.data);else if(x.isData3DTexture)N?(it&&e.texStorage3D(i.TEXTURE_3D,ft,St,nt.width,nt.height,nt.depth),st&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,nt.width,nt.height,nt.depth,ht,Lt,nt.data)):e.texImage3D(i.TEXTURE_3D,0,St,nt.width,nt.height,nt.depth,0,ht,Lt,nt.data);else if(x.isFramebufferTexture){if(it)if(N)e.texStorage2D(i.TEXTURE_2D,ft,St,nt.width,nt.height);else{let tt=nt.width,Z=nt.height;for(let _t=0;_t<ft;_t++)e.texImage2D(i.TEXTURE_2D,_t,St,tt,Z,0,ht,Lt,null),tt>>=1,Z>>=1}}else if(Bt.length>0){if(N&&it){const tt=ge(Bt[0]);e.texStorage2D(i.TEXTURE_2D,ft,St,tt.width,tt.height)}for(let tt=0,Z=Bt.length;tt<Z;tt++)lt=Bt[tt],N?st&&e.texSubImage2D(i.TEXTURE_2D,tt,0,0,ht,Lt,lt):e.texImage2D(i.TEXTURE_2D,tt,St,ht,Lt,lt);x.generateMipmaps=!1}else if(N){if(it){const tt=ge(nt);e.texStorage2D(i.TEXTURE_2D,ft,St,tt.width,tt.height)}st&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,ht,Lt,nt)}else e.texImage2D(i.TEXTURE_2D,0,St,ht,Lt,nt);m(x)&&d(j),yt.__version=q.version,x.onUpdate&&x.onUpdate(x)}w.__version=x.version}function Q(w,x,k){if(x.image.length!==6)return;const j=re(w,x),J=x.source;e.bindTexture(i.TEXTURE_CUBE_MAP,w.__webglTexture,i.TEXTURE0+k);const q=n.get(J);if(J.version!==q.__version||j===!0){e.activeTexture(i.TEXTURE0+k);const yt=Kt.getPrimaries(Kt.workingColorSpace),rt=x.colorSpace===Bn?null:Kt.getPrimaries(x.colorSpace),xt=x.colorSpace===Bn||yt===rt?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,x.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,x.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,xt);const Mt=x.isCompressedTexture||x.image[0].isCompressedTexture,nt=x.image[0]&&x.image[0].isDataTexture,ht=[];for(let Z=0;Z<6;Z++)!Mt&&!nt?ht[Z]=g(x.image[Z],!0,r.maxCubemapSize):ht[Z]=nt?x.image[Z].image:x.image[Z],ht[Z]=ye(x,ht[Z]);const Lt=ht[0],St=s.convert(x.format,x.colorSpace),lt=s.convert(x.type),Bt=T(x.internalFormat,St,lt,x.colorSpace),N=x.isVideoTexture!==!0,it=q.__version===void 0||j===!0,st=J.dataReady;let ft=P(x,Lt);Wt(i.TEXTURE_CUBE_MAP,x);let tt;if(Mt){N&&it&&e.texStorage2D(i.TEXTURE_CUBE_MAP,ft,Bt,Lt.width,Lt.height);for(let Z=0;Z<6;Z++){tt=ht[Z].mipmaps;for(let _t=0;_t<tt.length;_t++){const Ft=tt[_t];x.format!==sn?St!==null?N?st&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,_t,0,0,Ft.width,Ft.height,St,Ft.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,_t,Bt,Ft.width,Ft.height,0,Ft.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):N?st&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,_t,0,0,Ft.width,Ft.height,St,lt,Ft.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,_t,Bt,Ft.width,Ft.height,0,St,lt,Ft.data)}}}else{if(tt=x.mipmaps,N&&it){tt.length>0&&ft++;const Z=ge(ht[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,ft,Bt,Z.width,Z.height)}for(let Z=0;Z<6;Z++)if(nt){N?st&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,ht[Z].width,ht[Z].height,St,lt,ht[Z].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,Bt,ht[Z].width,ht[Z].height,0,St,lt,ht[Z].data);for(let _t=0;_t<tt.length;_t++){const se=tt[_t].image[Z].image;N?st&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,_t+1,0,0,se.width,se.height,St,lt,se.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,_t+1,Bt,se.width,se.height,0,St,lt,se.data)}}else{N?st&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,St,lt,ht[Z]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,Bt,St,lt,ht[Z]);for(let _t=0;_t<tt.length;_t++){const Ft=tt[_t];N?st&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,_t+1,0,0,St,lt,Ft.image[Z]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,_t+1,Bt,St,lt,Ft.image[Z])}}}m(x)&&d(i.TEXTURE_CUBE_MAP),q.__version=J.version,x.onUpdate&&x.onUpdate(x)}w.__version=x.version}function pt(w,x,k,j,J,q){const yt=s.convert(k.format,k.colorSpace),rt=s.convert(k.type),xt=T(k.internalFormat,yt,rt,k.colorSpace),Mt=n.get(x),nt=n.get(k);if(nt.__renderTarget=x,!Mt.__hasExternalTextures){const ht=Math.max(1,x.width>>q),Lt=Math.max(1,x.height>>q);J===i.TEXTURE_3D||J===i.TEXTURE_2D_ARRAY?e.texImage3D(J,q,xt,ht,Lt,x.depth,0,yt,rt,null):e.texImage2D(J,q,xt,ht,Lt,0,yt,rt,null)}e.bindFramebuffer(i.FRAMEBUFFER,w),vt(x)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,j,J,nt.__webglTexture,0,de(x)):(J===i.TEXTURE_2D||J>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,j,J,nt.__webglTexture,q),e.bindFramebuffer(i.FRAMEBUFFER,null)}function Nt(w,x,k){if(i.bindRenderbuffer(i.RENDERBUFFER,w),x.depthBuffer){const j=x.depthTexture,J=j&&j.isDepthTexture?j.type:null,q=y(x.stencilBuffer,J),yt=x.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,rt=de(x);vt(x)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,rt,q,x.width,x.height):k?i.renderbufferStorageMultisample(i.RENDERBUFFER,rt,q,x.width,x.height):i.renderbufferStorage(i.RENDERBUFFER,q,x.width,x.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,yt,i.RENDERBUFFER,w)}else{const j=x.textures;for(let J=0;J<j.length;J++){const q=j[J],yt=s.convert(q.format,q.colorSpace),rt=s.convert(q.type),xt=T(q.internalFormat,yt,rt,q.colorSpace),Mt=de(x);k&&vt(x)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Mt,xt,x.width,x.height):vt(x)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Mt,xt,x.width,x.height):i.renderbufferStorage(i.RENDERBUFFER,xt,x.width,x.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Tt(w,x){if(x&&x.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(i.FRAMEBUFFER,w),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const j=n.get(x.depthTexture);j.__renderTarget=x,(!j.__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),V(x.depthTexture,0);const J=j.__webglTexture,q=de(x);if(x.depthTexture.format===er)vt(x)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,J,0,q):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,J,0);else if(x.depthTexture.format===nr)vt(x)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,J,0,q):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,J,0);else throw new Error("Unknown depthTexture format")}function qt(w){const x=n.get(w),k=w.isWebGLCubeRenderTarget===!0;if(x.__boundDepthTexture!==w.depthTexture){const j=w.depthTexture;if(x.__depthDisposeCallback&&x.__depthDisposeCallback(),j){const J=()=>{delete x.__boundDepthTexture,delete x.__depthDisposeCallback,j.removeEventListener("dispose",J)};j.addEventListener("dispose",J),x.__depthDisposeCallback=J}x.__boundDepthTexture=j}if(w.depthTexture&&!x.__autoAllocateDepthBuffer){if(k)throw new Error("target.depthTexture not supported in Cube render targets");const j=w.texture.mipmaps;j&&j.length>0?Tt(x.__webglFramebuffer[0],w):Tt(x.__webglFramebuffer,w)}else if(k){x.__webglDepthbuffer=[];for(let j=0;j<6;j++)if(e.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer[j]),x.__webglDepthbuffer[j]===void 0)x.__webglDepthbuffer[j]=i.createRenderbuffer(),Nt(x.__webglDepthbuffer[j],w,!1);else{const J=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,q=x.__webglDepthbuffer[j];i.bindRenderbuffer(i.RENDERBUFFER,q),i.framebufferRenderbuffer(i.FRAMEBUFFER,J,i.RENDERBUFFER,q)}}else{const j=w.texture.mipmaps;if(j&&j.length>0?e.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer[0]):e.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer),x.__webglDepthbuffer===void 0)x.__webglDepthbuffer=i.createRenderbuffer(),Nt(x.__webglDepthbuffer,w,!1);else{const J=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,q=x.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,q),i.framebufferRenderbuffer(i.FRAMEBUFFER,J,i.RENDERBUFFER,q)}}e.bindFramebuffer(i.FRAMEBUFFER,null)}function Ce(w,x,k){const j=n.get(w);x!==void 0&&pt(j.__webglFramebuffer,w,w.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),k!==void 0&&qt(w)}function D(w){const x=w.texture,k=n.get(w),j=n.get(x);w.addEventListener("dispose",R);const J=w.textures,q=w.isWebGLCubeRenderTarget===!0,yt=J.length>1;if(yt||(j.__webglTexture===void 0&&(j.__webglTexture=i.createTexture()),j.__version=x.version,o.memory.textures++),q){k.__webglFramebuffer=[];for(let rt=0;rt<6;rt++)if(x.mipmaps&&x.mipmaps.length>0){k.__webglFramebuffer[rt]=[];for(let xt=0;xt<x.mipmaps.length;xt++)k.__webglFramebuffer[rt][xt]=i.createFramebuffer()}else k.__webglFramebuffer[rt]=i.createFramebuffer()}else{if(x.mipmaps&&x.mipmaps.length>0){k.__webglFramebuffer=[];for(let rt=0;rt<x.mipmaps.length;rt++)k.__webglFramebuffer[rt]=i.createFramebuffer()}else k.__webglFramebuffer=i.createFramebuffer();if(yt)for(let rt=0,xt=J.length;rt<xt;rt++){const Mt=n.get(J[rt]);Mt.__webglTexture===void 0&&(Mt.__webglTexture=i.createTexture(),o.memory.textures++)}if(w.samples>0&&vt(w)===!1){k.__webglMultisampledFramebuffer=i.createFramebuffer(),k.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,k.__webglMultisampledFramebuffer);for(let rt=0;rt<J.length;rt++){const xt=J[rt];k.__webglColorRenderbuffer[rt]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,k.__webglColorRenderbuffer[rt]);const Mt=s.convert(xt.format,xt.colorSpace),nt=s.convert(xt.type),ht=T(xt.internalFormat,Mt,nt,xt.colorSpace,w.isXRRenderTarget===!0),Lt=de(w);i.renderbufferStorageMultisample(i.RENDERBUFFER,Lt,ht,w.width,w.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+rt,i.RENDERBUFFER,k.__webglColorRenderbuffer[rt])}i.bindRenderbuffer(i.RENDERBUFFER,null),w.depthBuffer&&(k.__webglDepthRenderbuffer=i.createRenderbuffer(),Nt(k.__webglDepthRenderbuffer,w,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(q){e.bindTexture(i.TEXTURE_CUBE_MAP,j.__webglTexture),Wt(i.TEXTURE_CUBE_MAP,x);for(let rt=0;rt<6;rt++)if(x.mipmaps&&x.mipmaps.length>0)for(let xt=0;xt<x.mipmaps.length;xt++)pt(k.__webglFramebuffer[rt][xt],w,x,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+rt,xt);else pt(k.__webglFramebuffer[rt],w,x,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+rt,0);m(x)&&d(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(yt){for(let rt=0,xt=J.length;rt<xt;rt++){const Mt=J[rt],nt=n.get(Mt);let ht=i.TEXTURE_2D;(w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(ht=w.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(ht,nt.__webglTexture),Wt(ht,Mt),pt(k.__webglFramebuffer,w,Mt,i.COLOR_ATTACHMENT0+rt,ht,0),m(Mt)&&d(ht)}e.unbindTexture()}else{let rt=i.TEXTURE_2D;if((w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(rt=w.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(rt,j.__webglTexture),Wt(rt,x),x.mipmaps&&x.mipmaps.length>0)for(let xt=0;xt<x.mipmaps.length;xt++)pt(k.__webglFramebuffer[xt],w,x,i.COLOR_ATTACHMENT0,rt,xt);else pt(k.__webglFramebuffer,w,x,i.COLOR_ATTACHMENT0,rt,0);m(x)&&d(rt),e.unbindTexture()}w.depthBuffer&&qt(w)}function ue(w){const x=w.textures;for(let k=0,j=x.length;k<j;k++){const J=x[k];if(m(J)){const q=b(w),yt=n.get(J).__webglTexture;e.bindTexture(q,yt),d(q),e.unbindTexture()}}}const Ot=[],It=[];function gt(w){if(w.samples>0){if(vt(w)===!1){const x=w.textures,k=w.width,j=w.height;let J=i.COLOR_BUFFER_BIT;const q=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,yt=n.get(w),rt=x.length>1;if(rt)for(let Mt=0;Mt<x.length;Mt++)e.bindFramebuffer(i.FRAMEBUFFER,yt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Mt,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,yt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Mt,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,yt.__webglMultisampledFramebuffer);const xt=w.texture.mipmaps;xt&&xt.length>0?e.bindFramebuffer(i.DRAW_FRAMEBUFFER,yt.__webglFramebuffer[0]):e.bindFramebuffer(i.DRAW_FRAMEBUFFER,yt.__webglFramebuffer);for(let Mt=0;Mt<x.length;Mt++){if(w.resolveDepthBuffer&&(w.depthBuffer&&(J|=i.DEPTH_BUFFER_BIT),w.stencilBuffer&&w.resolveStencilBuffer&&(J|=i.STENCIL_BUFFER_BIT)),rt){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,yt.__webglColorRenderbuffer[Mt]);const nt=n.get(x[Mt]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,nt,0)}i.blitFramebuffer(0,0,k,j,0,0,k,j,J,i.NEAREST),l===!0&&(Ot.length=0,It.length=0,Ot.push(i.COLOR_ATTACHMENT0+Mt),w.depthBuffer&&w.resolveDepthBuffer===!1&&(Ot.push(q),It.push(q),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,It)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Ot))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),rt)for(let Mt=0;Mt<x.length;Mt++){e.bindFramebuffer(i.FRAMEBUFFER,yt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Mt,i.RENDERBUFFER,yt.__webglColorRenderbuffer[Mt]);const nt=n.get(x[Mt]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,yt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Mt,i.TEXTURE_2D,nt,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,yt.__webglMultisampledFramebuffer)}else if(w.depthBuffer&&w.resolveDepthBuffer===!1&&l){const x=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[x])}}}function de(w){return Math.min(r.maxSamples,w.samples)}function vt(w){const x=n.get(w);return w.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function kt(w){const x=o.render.frame;p.get(w)!==x&&(p.set(w,x),w.update())}function ye(w,x){const k=w.colorSpace,j=w.format,J=w.type;return w.isCompressedTexture===!0||w.isVideoTexture===!0||k!==Ni&&k!==Bn&&(Kt.getTransfer(k)===ee?(j!==sn||J!==pn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",k)),x}function ge(w){return typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement?(c.width=w.naturalWidth||w.width,c.height=w.naturalHeight||w.height):typeof VideoFrame<"u"&&w instanceof VideoFrame?(c.width=w.displayWidth,c.height=w.displayHeight):(c.width=w.width,c.height=w.height),c}this.allocateTextureUnit=O,this.resetTextureUnits=A,this.setTexture2D=V,this.setTexture2DArray=Y,this.setTexture3D=$,this.setTextureCube=X,this.rebindTextures=Ce,this.setupRenderTarget=D,this.updateRenderTargetMipmap=ue,this.updateMultisampleRenderTarget=gt,this.setupDepthRenderbuffer=qt,this.setupFrameBufferTexture=pt,this.useMultisampledRTT=vt}function gm(i,t){function e(n,r=Bn){let s;const o=Kt.getTransfer(r);if(n===pn)return i.UNSIGNED_BYTE;if(n===yo)return i.UNSIGNED_SHORT_4_4_4_4;if(n===To)return i.UNSIGNED_SHORT_5_5_5_1;if(n===fl)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===pl)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===ul)return i.BYTE;if(n===dl)return i.SHORT;if(n===Qi)return i.UNSIGNED_SHORT;if(n===Eo)return i.INT;if(n===oi)return i.UNSIGNED_INT;if(n===wn)return i.FLOAT;if(n===zi)return i.HALF_FLOAT;if(n===ml)return i.ALPHA;if(n===_l)return i.RGB;if(n===sn)return i.RGBA;if(n===er)return i.DEPTH_COMPONENT;if(n===nr)return i.DEPTH_STENCIL;if(n===gl)return i.RED;if(n===bo)return i.RED_INTEGER;if(n===vl)return i.RG;if(n===wo)return i.RG_INTEGER;if(n===Ao)return i.RGBA_INTEGER;if(n===Fr||n===Or||n===Br||n===zr)if(o===ee)if(s=t.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===Fr)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Or)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Br)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===zr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=t.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===Fr)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Or)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Br)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===zr)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Ws||n===Xs||n===Ys||n===qs)if(s=t.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===Ws)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Xs)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Ys)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===qs)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===js||n===Ks||n===Zs)if(s=t.get("WEBGL_compressed_texture_etc"),s!==null){if(n===js||n===Ks)return o===ee?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===Zs)return o===ee?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===$s||n===Js||n===Qs||n===to||n===eo||n===no||n===io||n===ro||n===so||n===oo||n===ao||n===lo||n===co||n===ho)if(s=t.get("WEBGL_compressed_texture_astc"),s!==null){if(n===$s)return o===ee?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Js)return o===ee?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Qs)return o===ee?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===to)return o===ee?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===eo)return o===ee?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===no)return o===ee?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===io)return o===ee?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===ro)return o===ee?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===so)return o===ee?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===oo)return o===ee?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===ao)return o===ee?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===lo)return o===ee?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===co)return o===ee?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===ho)return o===ee?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===uo||n===fo||n===po)if(s=t.get("EXT_texture_compression_bptc"),s!==null){if(n===uo)return o===ee?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===fo)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===po)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===mo||n===_o||n===go||n===vo)if(s=t.get("EXT_texture_compression_rgtc"),s!==null){if(n===mo)return s.COMPRESSED_RED_RGTC1_EXT;if(n===_o)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===go)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===vo)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===tr?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}const vm=`
void main() {
